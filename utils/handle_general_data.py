...
# @Author  : sunxuan
# @Site    : 
# @File    : handle_general_data.py
from  faker import Faker

#设置
'''
mimesis :https://mimesis.name/en/master/#api-reference
这个库专门用Python 创建各种假数据，比如一些数据库的测试数据，假API、Json、XML 等格式数据都可以通过它产生，

fake2db : https://github.com/emirozer/fake2db
另一个常需要用到假数据的就是数据库了，fake2db 这个库可以给数据库填充假数据，它可以支持我们常用到的数据库，
比如MySQL、Redis、Mongodb、Sqlite 等。
常用方法
1、地理信息类
city_suffix()：市，县
country()：国家
